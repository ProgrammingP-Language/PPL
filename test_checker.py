...
def test_069():
    """Variable redeclaration in single-statement if"""
    source = """
void main() {
    int a;
    int b;
...
def test_074():
    """Variable redeclaration in single-statement while"""
    source = """
void main() {
    int a;
    while(1) int a;
...
def test_086():
    """Redeclared variable inside the same case"""
    source = """
void main() {
    int a;
    switch (1) {
...
def test_087():
    """Redeclared variable across different cases in switch"""
    source = """
void main() {
    int a;
    switch (1) {
...
def test_145():
    """Switch expression is int but case label is float"""
    source = """
void main(){
    switch(1 || 2){
        case 1.0: 
...
def test_267():
    ...
    """
    assert Checker(source).check_from_source() == "TypeCannotBeInferred(BlockStmt([VarDecl(auto, c)]))"
...
def test_273():
    ...
    """
    assert Checker(source).check_from_source() == "TypeCannotBeInferred(BinaryOp(Identifier(b), +, FloatLiteral(1.0)))"
...
def test_284():
    ...
    """
    assert Checker(source).check_from_source() == "TypeCannotBeInferred(BinaryOp(Identifier(b), +, Identifier(c)))"
...
def test_304():
    ...
    """
    assert Checker(source).check_from_source() == "TypeCannotBeInferred(BinaryOp(FloatLiteral(1.0), +, Identifier(a)))"
...
def test_330():
    ...
    """
    assert Checker(source).check_from_source() == "TypeCannotBeInferred(BinaryOp(FuncCall(foo, []), +, Identifier(b)))"